package people.cs.vt.edu.shaffer.GenTree;
...
/**
 * Implementation of General Tree Nodes: Left Child/ Right Sibling
 * implementation (with parent pointer)
 */
public class GTNodeImpl<E> implements GTNode<E> {
	...
	public GTNodeImpl(E value, GTNodeImpl<E> par, GTNodeImpl<E> leftc, GTNodeImpl<E> rights) {
		element = value;
		rent = par;
		leftchild = leftc;
		rightsib = rights;
	...
	public GTNodeImpl<E> parent() {
		return rent;
	}

	public GTNodeImpl<E> leftmostChild() {
		return leftchild;
	}

	public GTNodeImpl<E> rightSibling() {
		return rightsib;
	}
